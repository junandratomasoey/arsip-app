...
/**
 * Skema standar paket spatie/laravel-permission (fitur "teams" dimatikan).
 * Ditulis manual mengikuti stub resmi paket, karena composer install belum
 * dijalankan saat migration ini dibuat. Setelah composer install, boleh
 * dibandingkan dengan stub asli di:
