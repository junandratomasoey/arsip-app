            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea wire:model="locationDescription" id="locationDescription" rows="2" class="mt-1 block w-full border-gray-300 focus:border-pu-navy-500 focus:ring-pu-navy-500 rounded-md shadow-sm"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea wire:model="providerAddress" id="providerAddress" rows="2" class="mt-1 block w-full border-gray-300 focus:border-pu-navy-500 focus:ring-pu-navy-500 rounded-md shadow-sm"></textarea>
                    </div>
                    <div>
                        ...
                        <div class="mt-2 flex flex-wrap gap-3">
                            @foreach ($tagOptions as $opt)
                                <label class="inline-flex items-center gap-1.5 text-sm text-gray-700">
                                    <input type="checkbox" wire:model="selectedTagIds" value="{{ $opt['id'] }}" class="rounded border-gray-300 text-pu-navy-600 shadow-sm">
                                    {{ $opt['name'] }}
                                </label>
                            @endforeach
                        </div>
