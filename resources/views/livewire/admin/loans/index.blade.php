                            ...
                            <tr>
                                ...
                                <td class="px-4 py-2 text-right space-x-3 text-xs whitespace-nowrap align-top">
                                    ...
                                    @elseif ($loan->status === 'approved')
                                        @can('loan.return')
                                            <button type="button" wire:click="confirmReturn('{{ $loan->id }}')" class="text-pu-navy-600 hover:underline">tandai dikembalikan</button>
                                        @endcan
                                    @endif
                                </td>
                            </tr>
            ...
            <div class="relative mb-6 bg-white rounded-lg overflow-hidden shadow-xl sm:max-w-sm sm:mx-auto">
                <form wire:submit="saveReject" class="p-6">
                    ...
                    <div>
                        ...
                        <textarea wire:model="rejectionReason" id="rejectionReason" rows="3" class="mt-1 block w-full border-gray-300 focus:border-pu-navy-500 focus:ring-pu-navy-500 rounded-md shadow-sm"></textarea>
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto px-4 py-6 sm:px-0">
            ...
            <div class="relative mb-6 bg-white rounded-lg overflow-hidden shadow-xl sm:max-w-md sm:mx-auto p-6">
                ...
                <div class="mt-6 flex justify-end gap-3">
                    ...
                    <button type="button" wire:click="markReturned" class="inline-flex items-center px-4 py-2 bg-pu-navy border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-pu-navy-700">
